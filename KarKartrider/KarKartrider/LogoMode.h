...
public:
    ...
    void init() override {
        ...
        loadModelWithProgress<KartModel>("bazzi_face.obj", "obj/character/", "chcracter", "box", glm::scale(glm::mat4(1.0f), glm::vec3(1.0, 1.0, 1.0)), character, true);
        loadModelWithProgress<KartModel>("bazzi_body.obj", "obj/character/", "chcracter", "box", glm::scale(glm::mat4(1.0f), glm::vec3(1.0, 1.0, 1.0)), character, true);
        ...
        loadModelWithProgress<MapModel>("villiage_unha.obj", "asset/select_mode/", "villiage_unha", "box", map2_matrix, selectMaps, false);
        ...
        loadModelWithProgress<MapModel>("arrow_key.obj", "asset/select_mode/", "arrow_key", "box", arrow_matrix, selectMaps, false);
